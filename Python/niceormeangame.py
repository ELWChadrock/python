...
# Python: 3.8.4
#
# Author: Chad Okulovich
#
# Purpose: The tech academy - python course, creating our first program together.
# demonstarting how to pass variables from function to function while producing a functional game.
#
# Remember, function_name(variable) _means that we pass in the variable.
# return variable _means that we are returning the variable to back to the calling function.
...
def score(nice,mean,name):
    # score function is being passed the vallues stored within the 3 variables
